const { launchOhmV2Market } = require("../../../deployTests/PolygonTransactions");
...
module.exports = async (hardhatDeployArguments) => {
  ...
  if (networkToUse == "polygon") {
    ...
    console.log("the funding rate is", await longShort.fundingRateMultiplier_e18(8))
  } else {
    console.error("This command is only available on polygon");
  }
